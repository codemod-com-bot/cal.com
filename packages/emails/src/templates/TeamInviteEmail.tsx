...
values={{ invitedBy, _strong_teamName_strong_: <strong>{teamName}</strong> }}
components={{"0": <strong />}}
/></Trans>{" "}
                <Trans
...
values={{ _strong_teamName_strong_: 
...
values={{ _a_href_newLink_orgRedirection_true_newLinkWithoutProtocol_a_: 
...
values={{ invitedBy, _strong_teamName_strong_: <strong>{teamName}</strong>, _strong_parentTeamName_strong_: 
