...
i18nKey="owner-added-organization"
values={{ WEBAPP_URL }}
components={{"0": 
...
values={{ _a_href_newLink_newLinkWithoutProtocol_a_: <a href={`${newLink}`}>{newLinkWithoutProtocol}</a> }}
...
values={{ _a_href_prevLink_prevLinkWithoutProtocol_a_: <a href={prevLink ?? ""}>{prevLinkWithoutProtocol}</a>, _a_href_newLink_newLinkWithoutProtocol_a_: 
            <a href={newLink ?? ""}>{newLinkWithoutProtocol}</a> }}
components={{"0": <a href={prevLink ?? ""} />, "1": 
            <a href={newLink ?? ""} />}}
/><br />
            <br /><Trans
i18nKey="personal-event-types-moved"
values={{ _strong_teamName_strong_: <strong>
              {teamName}
            </strong> }}
components={{"0": <strong />}}
/><br />
...
values={{ _a_href_newLink_orgRedirection_true_newLinkWithoutProtocol_a_: <a href={`${newLink}?orgRedirection=true`}>{newLinkWithoutProtocol}</a> }}
