...
const { t } = useTranslation();
  ...
  if (props.isAppDisabled) {
    if (!IS_PRODUCTION) {
      ...
      return (
        <div className="p-2">{t('this-app-seems-to-be-disabled-if-you-are-an-admin-you-can-enable-this-app-from')}
          <Link href="/settings/admin/apps" className="cursor-pointer text-blue-500 underline">{t('here')}</Link>
        </div>
      );
    }
