...
values={{ _span_className_font_normal_name_span_: <span className="font-normal">{name}</span> }}
...
/>
      ...
      <div className="flex items-start gap-4">
        <Button
          ...
          loading={isLoading}
          disabled={isLoading}
          onClick={() => router.push(`/settings/platform/oauth-clients/${id}/edit/webhooks`)}>{t('webhooks-header')}</Button>
        <Button
          color="secondary"
          loading={isLoading}
          disabled={isLoading}
